...
public class SecurityConfig {
    ...
    /*
    enabling http based anthentication
     */
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws  Exception{
        http.csrf().disable()  // disable the csrf token
                .authorizeHttpRequests((autorize)-> // this method is to authorize all http requests
//
